...
struct Constants {
    ...
    static let MY_INSTANCE_ADDRESS = "インスタンスへのアドレスを入力してください" // <- update this
    
    static let AUTH_URL  = URL(string: "https://\(MY_INSTANCE_ADDRESS)")!
    static let REALM_URL = URL(string: "realms://\(MY_INSTANCE_ADDRESS)/globalでreadonlyなrealmへのpath")!
}
